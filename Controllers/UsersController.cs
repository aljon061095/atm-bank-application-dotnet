...
namespace WebApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            var user = _userService.Authenticate(model.CardNumber, model.Password);

            if (user == null)
                return BadRequest(new { message = "Card number or password is incorrect" });
        ...
        public IActionResult ViewBalance([FromBody]UserModel model) 
        {
